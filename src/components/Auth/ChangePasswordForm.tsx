      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        field
              ...
              <div className="relative">
                <FormControl>
                  <Input type={showCurrentPassword ? "text" : "password"} placeholder="Informe sua senha atual" {...field} />
                </FormControl>
        ...
        field
              ...
              <div className="relative">
                <FormControl>
                  <Input type={showNewPassword ? "text" : "password"} placeholder="Informe sua nova senha" {...field} />
                </FormControl>
        ...
        field
              ...
              <div className="relative">
                <FormControl>
                  <Input type={showConfirmPassword ? "text" : "password"} placeholder="Confirme sua nova senha" {...field} />
                </FormControl>
        ...
        <Button type="submit" disabled={isLoading} className="w-full gap-0">
